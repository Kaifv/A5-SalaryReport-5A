      ...
      *will be writing from.
           ...
           select grad-file
           assign to "../../../A5-SalaryReport-5A.out"
           organization is line sequential.

           select non-grad-file
           assign to "../../../../A5-SalaryData-NonGrad.dat"
           organization is line sequential.
      ...
      *Output definition
       fd grad-file
           data record is grad-line
           record contains 120 characters.

       01 grad-line pic x(120).

       fd non-grad-file
           data record is non-grad-line
           record contains 120 characters.

       01 non-grad-line pic x(120).
      ...
      *report. SHowing my name and the date it was created.
       01 ws-report-heading.
         05 filler pic x(28) value "Kaifkhan Vakil, Assignment 5".
      ...
      *  heading at the start of each page which also shows the number.
       01 ws-report-heading1.
         ...
         05 filler pic x(22) value "GRADUATE SALARY REPORT".
      ...
      *be showing content of the file after reading from the input file.
       01 ws-detail-line.
         ...
         05 ws-increase-percentage-r redefines ws-increase-percentage.
         ...
         05 ws-budget-estimate pic zzz,zz9.99.
         05 filler pic x(1) value spaces.
         05 ws-budget-diff   pic ---,--9.99.
      ...
      *consisting of the average increases of classification.
       01 ws-total-line1.
         05 filler pic x(19) value " AVERAGE INCREASES:".
         05 filler pic x(3) value spaces.
      ...
      *  which i will be using later in my calculation
       01 ws-calcs.
         ...
         05 ws-budget-diff-calc    pic S9(6)v99 value 0.
      ...
      *later in the calculation.
       01 ws-counters.
         ...
         05 ws-diff-total  pic S9(5)v99 value 0.
      ...
      *    column headings too
       410-process-headings.
           if (ws-page-count > ws-one) then
               write grad-line from ws-report-heading1
                 after advancing page
           else
               write grad-line from ws-report-heading1
           end-if.
           write grad-line from ws-report-heading2
             after advancing ws-two lines.
           write grad-line from ws-report-heading3
      ...
      *    perform 470-process-non-graduates.
           if (il-education-code equals "N") then
               move input-line to non-grad-line
               write non-grad-line
           end-if.
      ...
      *while the record is of a graduate.
       460-process-graduates.
           ...
           compute ws-budget-diff-calc rounded = il-budget-estimate -
             ws-new-salary-calc
           .
           add ws-budget-diff-calc to ws-diff-total.
      ...
      *    This section displays detail output for the final report
       480-write-detail-line.
           ...
           move il-budget-estimate to ws-budget-estimate.
           move ws-budget-diff-calc to ws-budget-diff.
           write grad-line from ws-detail-line
      ...
      *This section takes care of the subtotal line
       490-write-subtotal-line.
           ...
           write grad-line from ws-subtotal-line1
             after advancing ws-one line.
           write grad-line from ws-sutotal-line2
             before advancing ws-two lines.
      ...
      *Open files
       010-open-files.
           ...
           open output grad-file.
           open output non-grad-file.

      *Write report heading
       020-write-report-heading.
           write grad-line from ws-report-heading
             before advancing ws-two lines.
      ...
      *Write total line at the end of the report.
       500-write-total-line.
           ...
           write grad-line from ws-total-line1
             after advancing ws-one line.
           write grad-line from ws-total-line2.

           move ws-diff-total to ws-show-total-diff.
           write grad-line from ws-total-dff
           after advancing ws-one line.

      *Close files
       600-close-file.
           close grad-file, non-grad-file, input-file.
